---
title: "Data Assembly: 2017 NHTS (All Purposes Trips)"
...
* Survey does not indicate that the child drove unaccompanied (assume these are survey coding errors),
* Survey does not indicate the child traveled by car with only siblings unless the child has a sibling who is a driver.

**Traveler**

* Traveler is between 8 and 13
* Traveler is not eligible for school bus service,
  * Not a school trip _or_,
  * Child did not use a school bus on the survey day.

#### Assembling Multi-stage trips

Trips with the purpose of transferring to another mode are included as separate trips rather than being linked together.
...
* **'independence'**: (string) For purposes of this analysis, we describe all female household adults as moms, all male household adults as dads, and all household children as siblings. Also note that NHTS codes all household members as either male or female. We know how many non-household members are on a trip, but we don't know their ages, genders, or drivers status.The full independence variable takes one of the following 6 values to describe who was with the child on their trip:
  ...
  * 22 = with mom: The child was accompanied by a female household adult _but no_ male household adult
  * 23 = with dad: The child was accompanied by a male household adult _but no_ female household adult
...
* **'mode_ind_3'**: Combination of mode and the simplified independence variable. Takes the following values:
  *720 = car with adult
  *730 = car with kid
  *810 = walk alone
...
**Travel-day variables**:
  ...
  * school_dist: Distance from home to school (km)
...
#### 2 Assemble ages and genders of household members
...
#### 4 Assemble all trips involving children
...
kid_short_trips |>
  ...
  kable(caption = "Modes excluded from analysis")
...
#### Outcome 3: Alternate simplified Independence Variable
