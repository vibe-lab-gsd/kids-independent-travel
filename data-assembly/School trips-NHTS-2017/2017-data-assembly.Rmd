...
* **'ind_3_alt'**: Same as 'ind_3a', but trips with non-household members (independence = 3) are classified as trips with kids. Since we don't know if the non-household members are kids or adults, we might want to test it both ways and see if it effects the result
...
#trips <- here("nhts",
              ...
              #"trippub.csv") |>
  #read_csv()
#people <- read_csv("perpub.csv") |>
  #mutate(person_hh = paste(PERSONID, HOUSEID, sep = "-")) #Joins Person & Household ID
