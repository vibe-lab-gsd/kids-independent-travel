---
title: "Data Assembly: 2017 NHTS (School Trips) - Join with 2009"
...
school_trips <- trips |>
  ...
  summarise(person_hh = first(person_hh),
            ...
            DBPPOPDN = last(DBPPOPDN)) |> ## Change density to household block
  group_by(person_hh) |>
...
transfers <- trips |>
  select(WHYTO, WHYFROM,TRPTRANS) |>
  filter (WHYTO == "07" | WHYFROM == "07")

transfers_freq <- transfers |>
  count(TRPTRANS)

ggplot(transfers_freq, aes(x = TRPTRANS, y = n)) +
  geom_bar(stat = "identity", fill = "skyblue") +
  labs(x = "Mode Categories", y = "Frequency in Transfer Trips", title = "Frequency of Mode Categories for 'Transfer' Trips") +
  theme_minimal() +
