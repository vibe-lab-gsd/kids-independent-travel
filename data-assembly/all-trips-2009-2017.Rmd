...
trips17 <- here("nhts",
  ...
  read_csv(show_col_types = FALSE) |>
  mutate(year = 2017) |>
  filter(WHYFROM %in% c("01","02") &    ## Remove filter for school trips
           TRPTRANS %in% c("01",
                           "02",
                           "03",
                           "04",
...
trips09 <- here("nhts",
  ...
  filter(WHYFROM == "01" &          ## Remove filter for school trips
           TRPTRANS %in% c("01",
                           "02",
                           "03",
                           "04",
...
trips <- rbind(trips09, trips17)|>
  ...
  filter(R_AGE > 6 &
         R_AGE < 15 & 
         TRPMILES < 1.25) ## Removed arrival/ENDTIME variables; keep to short trips
```
