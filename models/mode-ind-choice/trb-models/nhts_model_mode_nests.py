...
mode_nests_model = models.lognested(V, av, nests, mode_ind_3_alt)
...
# Estimate parameters
results = mode_nests_biogeme_est.estimate()
...
pandas_results.to_csv('biogeme_parameters_mode_nests.csv')
...
mode_nests_biogeme_sim = bio.BIOGEME(database_sim, simulate)
mode_nests_biogeme_sim.modelName = "predictions"

betaValues = results.getBetaValues ()
simulatedValues = mode_nests_biogeme_sim.simulate(betaValues)

simulatedValues.to_csv('biogeme_preds_mode-nests.csv')
