...
alpha_active = Beta('alpha_active', 0.25, 0, 1, 0)
alpha_parent = 1 - alpha_active

# Define nests based on mode
mu_parent = Beta('mu_parent', 1, 1.0, None, 0)
mu_active = Beta('mu_active', 1, 1.0, None, 0)
...
the_biogeme.modelName = 'cross_nest3'

# estimate parameters
results = the_biogeme.estimate()

pandas_results = results.getEstimatedParameters()
pandas_results.to_csv('cross-nest-with-par-base.csv', index=False)
