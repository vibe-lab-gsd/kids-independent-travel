...
# alternative specific constants (with parent is reference case)
...
# Define model
my_model = models.loglogit(V, av, mode_ind)

# Create biogeme object
the_biogeme = bio.BIOGEME(database_est, my_model)
the_biogeme.modelName = 'no_nests3'

# estimate parameters
results = the_biogeme.estimate()

pandas_results = results.getEstimatedParameters()
pandas_results.to_csv('no-nest-with-par-base.csv', index=False)
